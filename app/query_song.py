...
API_KEY = os.getenv(
    'API_KEY')  # Go to https://developer.spotify.com/console/get-audio-features-several-tracks/ and press 'Get
# Token'. It'll ask you to login to spotify to get a key.
...
def get_song_id_by_name(track_name):
    ...
    # Since not all of the tracks returned by the API are singles, we go through the tracks returned, get their IDs,
